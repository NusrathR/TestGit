...
public class WrapperMain {
		...
		//=================Keyboard Actions=======================
		public void KeyTabbyid(String id, String input) {
			try {
				driver.findElement(By.id(id)).clear();
				driver.findElement(By.id(id)).sendKeys(input,Keys.TAB);
	...
	public void nextWin(){
		...
		System.out.println("Next Window handle::"+nextwin1);
	...
	//- switchToPrimaryWindow
		...
		//====== Handling Excel Files =======
				...
				/*public XSSFRow getRow(int rowIndex){
					...
					Sheetname = wbook.getSheetAt(0);
		            return rownumber = Sheetname.getRow(rowIndex);
				...
				public XSSFCell getCellAt(int rowIndex,int cellnum){
					...
					XSSFCell ccell = null;
					Sheetname = wbook.getSheetAt(0);
		            rownumber = Sheetname.getRow(rowIndex);
