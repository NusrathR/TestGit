...
public class CompleteCode extends Wrapper{
		...
		public void testCase2FindLeads() throws InterruptedException {
			...
			if(verifyElementText(readExcel("TestData_main","FindLeads", 1, 1).getStringCellValue())){
			...
			if(verifyElementText(readExcel("TestData_main","FindLeads", 1, 2).getStringCellValue())){
